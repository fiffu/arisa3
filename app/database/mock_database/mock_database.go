...
func (m *MockIDatabase) Begin() (database.ITransaction, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Begin")
	ret0, _ := ret[0].(database.ITransaction)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockIDatabase) Exec(query string, args ...interface{}) (database.IResult, error) {
	m.ctrl.T.Helper()
...
func (m *MockIDatabase) Migrate(arg0 database.ISchema) error {
	m.ctrl.T.Helper()
...
func (m *MockIDatabase) ParseMigration(filepath string) (database.ISchema, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ParseMigration", filepath)
	ret0, _ := ret[0].(database.ISchema)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockIDatabase) Query(query string, args ...interface{}) (database.IRows, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{query}
	for _, a := range args {
		varargs = append(varargs, a)
...
// Exec mocks base method.
func (m *MockITransaction) Exec(query string, args ...interface{}) (database.IResult, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{query}
	for _, a := range args {
		varargs = append(varargs, a)
...
// Query mocks base method.
func (m *MockITransaction) Query(query string, args ...interface{}) (database.IRows, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{query}
	for _, a := range args {
		varargs = append(varargs, a)
